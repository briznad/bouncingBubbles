var geoip2=function(){"use strict";function Lookup(successCallback,errorCallback,options,type){this.successCallback=successCallback,this.errorCallback=errorCallback,this.timeout=options&&void 0!==options.timeout?2e3>options.timeout?2e3:options.timeout:1e4,this.w3c_geolocation_disabled=options?options.w3c_geolocation_disabled:!1,this.geolocation=options&&options.hasOwnProperty("geolocation")?options.geolocation:navigator.geolocation,this.type=type}var exports={};Lookup.prototype.returnSuccess=function(location){this.successCallback&&"function"==typeof this.successCallback&&this.successCallback(this.fillInObject(this.objectFromJSON(location)))},Lookup.prototype.returnError=function(error){this.errorCallback&&"function"==typeof this.errorCallback&&(error||(error={error:"Unknown error"}),this.errorCallback(error))},Lookup.prototype.objectFromJSON=function(json){return window.JSON!==void 0&&"function"==typeof window.JSON.parse?window.JSON.parse(json):eval("("+json+")")};var fillIns={country:[["continent",{},"names",{}],["country",{},"names",{}],["registered_country",{},"names",{}],["represented_country",{},"names",{}],["traits",{}]],city:[["city",{},"names",{}],["continent",{},"names",{}],["country",{},"names",{}],["location",{}],["postal",{}],["registered_country",{},"names",{}],["represented_country",{},"names",{}],["subdivisions",[],0,{},"names",{}],["traits",{}]]};return Lookup.prototype.fillInObject=function(obj){for(var fill="country"==this.type?fillIns.country:fillIns.city,i=0;fill.length>i;i++)for(var path=fill[i],o=obj,j=0;path.length>j;j+=2){var key=path[j];o[key]||(o[key]=path[j+1]),o=o[key]}return obj},Lookup.prototype.geoipLookup=function(http_params){var param,request,that=this,uri="//geoip.maxmind.com/geoip/v2.0/"+this.type+"/me?";if(!this.alreadyRan){this.alreadyRan=1,"Microsoft Internet Explorer"===navigator.appName&&window.XDomainRequest&&-1==navigator.appVersion.indexOf("MSIE 1")?(request=new XDomainRequest,http_params.referrer=document.URL,uri=window.location.protocol+uri):(request=new window.XMLHttpRequest,uri="https:"+uri);for(param in http_params)http_params.hasOwnProperty(param)&&http_params[param]&&(uri+=param+"="+encodeURIComponent(http_params[param])+"&");uri=uri.substring(0,uri.length-1),request.open("GET",uri,!0),request.onload=function(){request.status===void 0||200===request.status?that.returnSuccess(request.responseText):that.returnError(that.objectFromJSON(request.responseText))},request.ontimeout=function(){that.returnError({code:"HTTP_TIMEOUT",error:"The request to the GeoIP2 web service timed out."})},request.onerror=function(){that.returnError({code:"HTTP_ERROR",error:"There was an error making the request to the GeoIP2 web service."})},request.send(null)}},Lookup.prototype.getGeoIPResult=function(){var that=this,w3c_options={enableHighAccuracy:!0};return w3c_options.timeout=this.timeout-1e3,this.w3c_geolocation_disabled?(that.geoipLookup({geolocation_status:"DISABLED"}),void 0):(this.geolocation?(setTimeout(function(){that.geoipLookup({geolocation_status:"API_TIMEOUT"})},this.timeout),this.geolocation.getCurrentPosition(function(position){that.geoipLookup(position.coords)},function(error){var error_strs=["PERMISSION_DENIED","POSITION_UNAVAILABLE","TIMEOUT"];that.geoipLookup({geolocation_status:error_strs[error.code-1]})},w3c_options)):that.geoipLookup({geolocation_status:"UNSUPPORTED"}),void 0)},exports.country=function(successCallback,errorCallback,options){var l=new Lookup(successCallback,errorCallback,options,"country");l.getGeoIPResult()},exports.city=function(successCallback,errorCallback,options){var l=new Lookup(successCallback,errorCallback,options,"city");l.getGeoIPResult()},exports.cityISPOrg=function(successCallback,errorCallback,options){var l=new Lookup(successCallback,errorCallback,options,"city_isp_org");l.getGeoIPResult()},exports.omni=function(successCallback,errorCallback,options){var l=new Lookup(successCallback,errorCallback,options,"omni");l.getGeoIPResult()},exports}();
...
;(function( $, window, document, undefined ) {
	...
	// briznad: ommitting getStyleObject method, as it's only used by other commented out code. for further info see line 497
	// (function($){
